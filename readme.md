...
То есть, 1000 раз выполняется запрос `set names utf8` оттранслированный шаблонизатором и отпрепарированный pdo. При этом делается финт для предотвращения сохранения и повторного использования оттранслированного запроса.
